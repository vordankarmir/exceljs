...
const Dimensions = require("../../document/range");
const StringBuf = require("../../utils/string-buf");

const Row = require("../../document/row");
const Column = require("../../document/column");

const SheetRelsWriter = require("./sheet-rels-writer");
const SheetCommentsWriter = require("./sheet-comments-writer");
const DataValidations = require("../../document/data-validations");
...
class WorksheetWriter {
  ...
  _writeSheetFormatProperties(xmlBuf, properties) {
    ...
    xmlBuf.addText(
      xform.sheetFormatProperties.toXml(sheetFormatPropertiesModel)
    );
  }
